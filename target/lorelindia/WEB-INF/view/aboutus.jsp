...
<p class="lead">Lorel is an Indian cosmetics brand which is owned by Hindustan Unilever. Having Aishwarya Rai as our Brand Ambassador, it's ranked as number 1 among the cosmetics brands in India.</p>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <div class="team-member" data-animate="fadeInUp">
                                <div class="image">
                                    <a href="#">
                                        <img src="resources\img\IMG-20160627-WA0066.jpg" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                                <h3><a href="#">Saranya..R</a></h3>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="#">
                                        <img src="resources\img\1478161777928.jpg" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                                <br>
                                
                                <h3><a href="#">M.S.Sidhartha</a></h3>
                                <p class="role">CTO</p>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="#">
                                        <img src=" resources\img\images (12).jpg" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                                <h3><a href="#">Anoushka Shetty</a></h3>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="#">
                                        <img src="resources\img\2016-05-03 00.35.35.jpg" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                                <h3><a href="#">Aishwarya.D.U</a></h3>

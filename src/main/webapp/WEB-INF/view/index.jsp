...
<title>Lorel India</title>

<meta name="resources/css/keywords" content="">

<link
	href="resources/css/fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,500,700,800"
					...
					<div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-7 text-center">
                                    <img class="img-responsive" src="resources\img\def.jpg" alt="">
                                </div>

                                <div class="col-sm-5">
                                    <h2>Lorel India</h2>
                                    <ul class="list-style-none">
                                        <li>World's Largest Dealers</li>
                                        <li>Indian Cosmetics</li>
                                        <li>Brand Variations</li>
                                        <li>Sale's </li>
                                        <li>New Launces</li>
                                        <li>Exciting Offer's and much more!</li>
                                        <li>Gifts and much more!</li>
                                    </ul>
                                </div>
                        ...
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <img class="img-responsive" src="resources\img\b6.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="row">
                                <div class="col-sm-11">
                                    <img class="img-responsive" src="resources\img\e3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <h2><p class="lead">We have worked with many clients and we always like to hear they come out from the cooperation happy and satisfied. Have a look what our clients said about us.</p></h2>
                                ...
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="img-responsive" alt="" src="img/person-1.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="img-responsive" alt="" src="img/person-2.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="img-responsive" alt="" src="img/person-3.png">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
                            ...
                            <li class="item">
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="img-responsive" alt="" src="img/person-4.jpg">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
		...
		<footer id="footer">
			<div class="container">
				<div class="col-md-3 col-sm-6">
					...
					<p>Lorel is an Indian cosmetics brand which is owned by
						Hindustan Unilever. Having Aishwarya Rai as the ambassador, it
						ranked at number 1 among the cosmetics brands in India.</p>
				...
				<div class="col-md-3 col-sm-6">
					...
					<p>
						<strong>Lorel India Ltd.</strong> <br>37/5 New Avenue <br>
						Ulsoor Lake <br>Bangalore <br>Karnataka <br> <strong>India</strong>
					</p>
					<br> 
					<br> 
				...
				<div class="col-md-5 col-sm-3">
					...
					<h4>Our Top Brand Ambassadors</h4>

					<div class="photostream">
						<div>
							<a href="#"> <img class="img-responsive" src="resources\img\1.jpg"
								 alt="#" height="100" width="100">
							</a>
						</div>
						<div>
							<a href="#"> <img class="img-responsive" src="resources\img\8.jpg"
								  alt="#" height="100" width="100">
							</a>
						</div>
						
						<div>
							<a href="#"> <img class="img-responsive" src="resources\img\4.jpg"
								  alt="#" height="100" width="100">
							</a>
						</div>
						<div>
							<a href="#"> <img class="img-responsive" src="resources\img\5.jpg"
								 alt="#" height="100" width="100">
							</a>
						</div>
...
_________________________________________________________ -->
	...
	<script src="resources/css/fonts/bootstrap.min.js"></script>

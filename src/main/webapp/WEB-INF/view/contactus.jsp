...
<head>
    ...
    <title>Lorel India-Contact Us</title>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p class="text-center text-muted">
							<a href="reggister"><strong>Register now</strong></a>! It is easy
						...
						<div class="col-md-12">
							<section>
								...
								<p class="lead">Are you curious about something? Do you have
									...
									settled at limited civilly fortune me. Really spring in extent
									an by. Judge but built gay party world. Of so am he remember
									although required. Bachelor unpacked be advanced at. Confined
									in declared marianne is vicinity.</p>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="box-simple">
								...
								<h3>Address</h3>
								<p>
									37/5 New Avenue <br>Ulsoor Lake,Bangalore <br>Karnataka<strong>India</strong>
								</p>
							</div>
							<!-- /.box-simple -->
						</div>
						...
						<div class="col-md-4">
							...
							<div class="box-simple">
								...
								<p class="text-muted">This number is toll free if calling
									from India otherwise we advise you to use the
									electronic form of communication.</p>
								<p>
									<strong>+91 354 624 1800</strong>
								</p>
							</div>
							<!-- /.box-simple -->
						...
						<div class="col-md-4">
							...
							<div class="box-simple">
								...
								<ul class="list-style-none">
									<li><strong><a href="mailto:">swastik_joa@yahoo.in</a></strong>
									</li>
								</ul>
							</div>
							<!-- /.box-simple -->
